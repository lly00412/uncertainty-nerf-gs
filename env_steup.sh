...
ns-train active-nerfacto --data /mnt/Data2/nerf_datasets/m360/garden/ --output-dir output/m360/kitchen_0.1 --experiment-name kitchen --method-name active-nerfacto --timestamp main --pipeline.model.camera-optimizer.mode off --viewer.quit-on-train-completion True sparse-mipnerf360v2 --num_train_images 10 --downscale-factor 4
...
ns-train active-nerfacto --data /mnt/Data2/nerf_datasets/m360/garden/ --output-dir output/m360/garden_v20 --experiment-name garden --method-name active-nerfacto --timestamp main --pipeline.model.camera-optimizer.mode off --viewer.quit-on-train-completion True sparse-mipnerf360v2 --num_train_images 30 --downscale-factor 4