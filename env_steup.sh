...
ns-train nerfacto-mcdropout --data /mnt/Data2/nerf_datasets/m360/kitchen/ --output-dir output/m360/kitchen_0.1 --experiment-name kitchen --method-name nerfacto-mcdropout --timestamp main --pipeline.model.camera-optimizer.mode off --viewer.quit-on-train-completion True sparse-mipnerf360v2 --num_train_images 10 --downscale-factor 4
