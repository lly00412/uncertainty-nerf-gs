...
#        --output-dir output/nerf_synthetic/ship_v20 --experiment-name ship \
#        --method-name nerfacto-mcdropout --timestamp main \
#        --pipeline.model.camera-optimizer.mode off \
#        --viewer.quit-on-train-completion True sparse-blender --num_images 30 \
#        --seed_random_split seed1

ns-eval-unc vcurf-config --load-config ./output/nerf_synthetic/ship_v20/ship/nerfacto-mcdropout/main/config.yml \
        --sampling-method depth \
        --output-path ./output/nerf_synthetic/ship_v20/ship/vcurf/nerfacto-mcdropout/main/depth_l2/metrics.json \
        --dataset-path  /mnt/Data2/nerf_datasets/nerf_synthetic/ship/  \
        --render-output-path ./output/nerf_synthetic/ship_v20/ship/vcurf/nerfacto-mcdropout/main/depth_l2/plots --save-rendered-images --unc-max 0.3
