...
#
## Train activenerf
ns-train active-nerfacto --data /mnt/Data2/nerf_datasets/m360/bicycle/ --output-dir output/m360/bicycle_v60 --experiment-name bicycle --method-name active-nerfacto --timestamp main --pipeline.model.camera-optimizer.mode off --viewer.quit-on-train-completion True sparse-mipnerf360v2 --num_train_images 60 --downscale-factor 1
