...
# Train mcdropout
ns-train nerfacto-mcdropout --data /mnt/Data2/nerf_datasets/m360/kitchen/ --output-dir output/m360/kitchen_v30 --experiment-name kitchen --method-name nerfacto-mcdropout --timestamp main --pipeline.model.camera-optimizer.mode off --viewer.quit-on-train-completion True sparse-mipnerf360v2 --num_train_images 30 --downscale-factor 4
