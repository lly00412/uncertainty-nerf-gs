...
from nerfuncertainty.models.vcurf.vcurf_pipeline import VCURFPipeline



def eval_load_vcurf_checkpoint(
    config: TrainerConfig, pipeline: Pipeline, config_path: Path
) -> Tuple[Path, int]:
    ...
    load_dir = config_path.parent / "nerfstudio_models"
...
def vcurf_eval_setup(
    ...
    assert isinstance(pipeline, VCURFPipeline)
    pipeline.eval()

    # load checkpointed information
    checkpoint_path, step = eval_load_vcurf_checkpoint(
